...
DataCurso ::DataCurso(string nombre, string Descripcion, Dificultad Complejidad, int CantLecciones, bool Habilitado, int Promedio, string IdiomaC, string ProfesorC)
{
    this->Nombre = nombre;
